...
- Я в своей презентации постараюсь быть минимально академичным.
<!-- - Спасибо википедии -->
<!-- - Каждый из вас - отдельный сервер -->
...
<!-- Чистый лист -->
.center[![:scale 1050px](images/game-1-1.svg)]

???

- Знакомьтесь, чистый лист.
- Щас мы его постепенно заполним, а пока пару слов о концеции.
- Это — ваш жесткий диск. У каждого узла в Raft'е должно быть
