...
???
- Во-вторых было чисто функциональное ограничение
- SQL есть, но только локальный
- А шардирование уровнем выше, это странно
...
- Вся экосистема вокруг тарантула была достаточно специфичной
- Это во-первых _обучение_ делает более трудным
...
Очень интересно, но сложно
## Эксплуатация
То слишком гибко, то слишком жестко
???
- Ну и наконец про эксплуатацию
- Гибко - это когда управлять надо каждым репликасетом в отдельности
- А типичный кластер ­это 100 роутеров 100 репликасетов стораджей по два
  инстанса в каждом.
